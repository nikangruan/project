...
class Ueditor extends Controller
{
	...
	private function upFile($fieldName){
		...
		$info = $file->move(ROOT_PATH.'public'.DS.'upload'.DS.'ueditor'.DS.'image');
		if($info){//上传成功
			$fname='../../../upload/ueditor/image/'.str_replace('\\','/',$info->getSaveName());
	...
	private function fileList($allowFiles,$listSize,$get){
		$dirname = './public/upload/ueditor/image/';
	...
	*/
	...
	private function saveRemote($config,$fieldName){
	    ...
	    $dirname = './public/upload/ueditor/remote/';
	    $file['oriName'] = $m ? $m[1] : "";
	...
	*/
	private function upBase64($config,$fieldName){
	    ...
	    $dirname = './public/upload/ueditor/scrawl/';
	    $file['filesize'] = strlen($img);
